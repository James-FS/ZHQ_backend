...
type ChatSession struct {
	BaseModel
	SessionID    string     `json:"session_id" gorm:"type:varchar(36);uniqueIndex;not null comment:对话ID"` // 会话ID（支持群组）
	...
	UserID1      string     `json:"user_id1" gorm:"index;not null"`                                       // 用户1
	UserID2      string     `json:"user_id2" gorm:"index;not null"`                                       // 用户2
